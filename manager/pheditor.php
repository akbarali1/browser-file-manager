      ...
      <div class="col-9">
        <div class="card" style="background: cadetblue;">
          <div class="savebackupedix" style=" display: -webkit-inline-box; ">
            ...
            <img src="./assets/icons/svg/warning.svg" alt="The file was not saved. Refresh the page" title="The file was not saved. Refresh the page" id="error-message" style="display:none;padding: 15px;max-width: 100%;width: 60px;">
